...
namespace Vipertecpro\Laravel\VisitorTracker;
...
class VisitStats
{
    ...
    {
        // Summary
        Route::get('/stats', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@summary')->name('visitortracker.summary');

        // Visits
        Route::get('/stats/all', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@allRequests')->name('visitortracker.all_requests');
        Route::get('/stats/visits', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@visits')->name('visitortracker.visits');
        Route::get('/stats/ajax', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@ajaxRequests')->name('visitortracker.ajax_requests');
        Route::get('/stats/bots', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@bots')->name('visitortracker.bots');
        Route::get('/stats/login-attempts', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@loginAttempts')->name('visitortracker.login_attempts');

        // Grouped visits
        Route::get('/stats/countries', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@countries')->name('visitortracker.countries');
        Route::get('/stats/os', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@os')->name('visitortracker.os');
        Route::get('/stats/browsers', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@browsers')->name('visitortracker.browsers');
        Route::get('/stats/languages', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@languages')->name('visitortracker.languages');
        Route::get('/stats/unique', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@unique')->name('visitortracker.unique');
        Route::get('/stats/users', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@users')->name('visitortracker.users');
        Route::get('/stats/urls', '\Vipertecpro\Laravel\VisitorTracker\Controllers\StatisticsController@urls')->name('visitortracker.urls');
    }
    ...
    {
        if (in_array('login_attempts', $fields, true)) {
            $this->where('v.is_login_attempt', '!=', true);
        }

        if (in_array('bots', $fields, true)) {
            $this->where('v.is_bot', '!=', true);
        }

        if (in_array('ajax', $fields, true)) {
