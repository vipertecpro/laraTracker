...
[Live Demo](http://www.visitors.vipertecpro.com/)

## Installation - Basic
1) Install the package using composer:

```bash
composer require vipertecpro/laravel-visitor-tracker
```
...
protected $middlewareGroups = [
    ...
    'web' => [
        ...
        \Vipertecpro\Laravel\VisitorTracker\Middleware\RecordVisits::class,
    ],
    ...
];
```
...
'providers' => [
    ...
    Vipertecpro\Laravel\VisitorTracker\VisitorTrackerServiceProvider::class,
    ...
],
...
```
...
'aliases' => [
    ...
    'VisitStats' => Vipertecpro\Laravel\VisitorTracker\Facades\VisitStats::class,
    ...
],
...
```
...
Choose `Vipertecpro\Laravel\VisitorTracker\VisitorTrackerServiceProvider` in the provided list.
...
In case you are not content with the provided views, you can use the `Vipertecpro\Laravel\VisitorTracker\Facades\VisitStats` class to fetch the statistics data and then make your own controller and views to display this data.
