        ...
        for ($i = 0; $i < $this->visitCount; $i++) {
            try {
                $data = [
                    ...
                    'os_family' => ['Windows', 'Linux'][random_int(0, 1)],
                    'os' => ['Windows 10.0', 'Ubuntu'][random_int(0, 1)],
                    'browser_family' => ['Chrome', 'Firefox'][random_int(0, 1)],
                    'browser' => ['Chrome 67.0', 'Firefox 58.0'][random_int(0, 1)],
                    'country' => ['Russia', 'Philippines'][random_int(0, 1)],
                    'country_code' => ['RU', 'PH'][random_int(0, 1)],
                    'city' => ['Moscow', 'St. Petersburg', 'Manila', 'Cebu'][random_int(0, 3)],
                    'lat' => 123.235435,
                    'long' => 23.235435,
                    'browser_language_family' => ['ru', 'en', 'tl'][random_int(0, 1)],
                    'browser_language' => ['ru-RU', 'en-US', 'tl-PH'][random_int(0, 1)],
